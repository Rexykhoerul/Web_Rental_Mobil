                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card alert">
                                    ...
                                    <a href="tambah_rental.php" type="button" class="btn btn-rounded btn-success">Tambah
                                        Data
                                        Rental</a>
                                    <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($data = mysqli_fetch_array($tampil)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?= $data['tgl_rental_rexy'] ?>
                                                            </td>
                                                            <td>
                                                                <?= $data['nama_rexy'] ?>
                                                            </td>
                                                            <td>
                                                                <?= $data['nama_mobil_rexy'] . ' - ' . $data['no_plat_rexy'] ?>
                                                            </td>
                                                            <td>Rp.
                                                                <?= number_format($data['harga_rexy'], 0, ',', '.') ?>
                                                            </td>
                                                            <td>
                                                                <?= $data['lama_rexy'] ?> Hari
                                                            </td>
                                                            <td>Rp.
                                                                <?= number_format($data['total_rexy'], 0, ',', '.') ?>
                                                            </td>
                                                            <td>
                                                                <a href="edit_rental.php?no_trx_rexy=<?= $data['no_trx_rexy'] ?>"
                                                                    class='btn btn-rounded btn-primary'>Edit</a>
                                                                <a href="delete_rental.php?no_trx_rexy=<?= $data['no_trx_rexy'] ?>"
