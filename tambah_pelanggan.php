...
'login.php'</script>";
    ...
    <head>
        ...
        <title>RMP : Tambah Pelanggan</title>
                        ...
                        <div class="col-lg-8 p-r-0 title-margin-right">
                            <div class="page-header">
                                <div class="page-title">
                                    <h1>HALAMAN TAMBAH DATA PELANGGAN</h1>
                                </div>
                            </div>
                        </div>
                        <!-- /# column -->
                                ...
                                <div class="card alert">
                                    ...
                                    <div class="card-body">
                                        <div class="basic-form">
                                            <form method="POST" action="fungsi_tambah_pelanggan.php">
                                                <div class="form-group">
                                                    <label for="nik_ktp_rexy" class="form-label">NO NIK</label>
                                                    <input type="number" name="nik_ktp_rexy" class="form-control"
                                                        id="nik_ktp_rexy" placeholder="Masukan No NIK KTP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_rexy" class="form-label">Nama Pelanggan :</label>
                                                    <input type="text" name="nama_rexy" class="form-control"
                                                        id="nama_rexy" placeholder="Masukan Nama Pelanggan" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="no_hp_rexy" class="form-label">No HP :</label>
                                                    <input type="number" name="no_hp_rexy" class="form-control"
                                                        id="no_hp_rexy" placeholder="Masukan No HP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alamat_rexy" class="form-label">Alamat :</label>
                                                    <textarea name="alamat_rexy" class="form-control" id="alamat_rexy"
