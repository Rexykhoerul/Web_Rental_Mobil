...
'login.php'</script>";
    ...
    <head>
        ...
        <title>RMP : Tampil Pelanggan</title>
                ...
                <div class="container-fluid">
                    ...
                    <div id="main-content">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="card alert">
                                    ...
                                    <a href="tambah_pelanggan.php" type="button" class="btn btn-rounded btn-success">Tambah Data
                                        Pelanggan</a>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a href="edit_pelanggan.php?nik_ktp_rexy=<?= $data['nik_ktp_rexy'] ?>" class='btn btn-rounded btn-primary'>Edit</a>
                                                            <a href="delete_pelanggan.php?nik_ktp_rexy=<?= $data['nik_ktp_rexy'] ?>" class='btn btn-rounded btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Copyright © 2024 rexydinda Noor Aziza</p>
                        </div>
