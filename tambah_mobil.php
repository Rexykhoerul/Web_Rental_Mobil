                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="fungsi_tambah_mobil.php">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="no_plat_rexy" class="form-control"
                                                        id="no_plat_rexy" placeholder="Masukan No Plat" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nama_mobil_rexy" class="form-label">Nama Mobil :</label>
                                                    <input type="text" name="nama_mobil_rexy" class="form-control"
                                                        id="nama_mobil_rexy" placeholder="Masukan Nama Mobil" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="brand_mobil_rexy" class="form-label">Nama Brand Mobil
                                                        :</label>
                                                    <input type="text" name="brand_mobil_rexy" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select for="tipe_transmisi_rexy" name="tipe_transmisi_rexy"
                                                        class="form-control" id="tipe_transmisi_rexy" required>
